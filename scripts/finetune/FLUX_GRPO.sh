...
#pip3 install trl
torchrun --nproc_per_node=8 --master_port 19006 \
    fastvideo/train_grpo_flux_consist.py \
    --seed 42 \
    ...
    --allow_tf32 \
    --cfg 0.0 \
    --output_dir data/outputs/grpo_consist_mix_8_0_new \
    --h 720 \
    --w 720 \
    --t 1 \
    --sampling_steps 16 \
