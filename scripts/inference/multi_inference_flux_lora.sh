#!/bin/bash
# ==============================================================================
# Multi-Checkpoint Inference Script for Flux LoRA Models
# ==============================================================================
# Description:
...
#   EMA variants and already-processed checkpoints.
#
# Usage:
...
#
# Example:
#   bash scripts/inference/multi_inference_flux_lora.sh ./outputs/grpo_exp 0,1,2,3 4
# ==============================================================================
...
for ckpt_dir in "$BASE_CKPT_DIR"/*checkpoint-*; do
    ...
    if [ -d "$ckpt_dir" ] && [ -f "${ckpt_dir}/pytorch_lora_weights.safetensors" ]; then
        ...
        CUDA_VISIBLE_DEVICES="$2" torchrun \
            ...
            --model_path "${ckpt_dir}/pytorch_lora_weights.safetensors" \
